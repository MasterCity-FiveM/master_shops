...
Config.Map = {
  ...
  {name="Shop",color=2, id=52,x =26.21539, y =-1347.231, z =29.48206},
  ...
  {name="Shop",color=2, id=52,x =547.431, y =2671.710, z =41.156},
  {name="Shop",color=2, id=52,x =1961.464, y =3740.672, z =31.343},
  {name="Shop",color=2, id=52,x =2678.916, y =3280.671, z =54.241},
  {name="Shop",color=2, id=52,x =1729.216, y =6414.131, z =34.037},
  {name="Shop",color=2, id=52,x =1135.808, y =-982.281, z =45.415},
  {name="Shop",color=2, id=52,x =-1222.915, y =-906.983, z =11.326},
  {name="Shop",color=2, id=52,x =-1487.553, y =-379.107, z =39.163},
  ...
  {name="Digital Shop",color=37, id=521,x= -510.39559936523, y=281.68353271484, z= 83.21},
  {name="Digital Shop",color=37, id=521,x= -409.6088, y=32.12308, z= 46.51721},
...
Config.Zones = {
    ...
    TwentyFourSeven = {
        ...
        Pos = {
			...
			{x = 26.21539,  y = -1347.231,z = 28.48206}
        }
    },
    ...
    DigitalShop = {
        ...
        Pos = {
            ...
            {x= -510.39559936523, y=281.68353271484, z= 82.216064453125},
            {x= -409.60879516602, y=32.123081207275, z= 45.517211914063},
        }
    },
